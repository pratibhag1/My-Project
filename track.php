        ...
        $iron = $_POST['iron'];
                ...
                try {
                        ...
                        $stmt = $db->prepare("INSERT INTO `Track`
                                                        (calories, protein, carbohydrates, fiber, sugar, fat, cholesterol, sodium, potassium, vitamina, vitaminc, calcium, iron) VALUES
                                                        (:calories, :protein, :carbohydrates, :fiber, :sugar, :fat, :cholesterol, :sodium, :potassium, :vitamina, :vitaminc, :calcium, :iron)");
